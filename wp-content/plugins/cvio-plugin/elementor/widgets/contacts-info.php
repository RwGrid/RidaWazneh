...
class Cvio_Contacts_Info_Widget extends Widget_Base {

	public function get_name() {
		return 'cvio-contacts-info';
	}

	public function get_title() {
		return esc_html__( 'Contacts Info', 'cvio-plugin' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'items',
			[
				'label' => esc_html__( 'Contacts Items', 'cvio-plugin' ),
...
Plugin::instance()->widgets_manager->register_widget_type( new Cvio_Contacts_Info_Widget() );
