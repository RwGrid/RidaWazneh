...
if ( ! function_exists( 'cvio_setup' ) ) :
	...
	function cvio_setup() {
		...
		// Image Sizes
		add_image_size( 'cvio_160xAuto', 160, 9999, false );
		add_image_size( 'cvio_282x232', 282, 232, true );
		add_image_size( 'cvio_282x282', 282, 282, true );
		add_image_size( 'cvio_500x500', 500, 500, true );
		add_image_size( 'cvio_680xAuto', 680, 9999, false );
		add_image_size( 'cvio_680x680', 680, 680, true );
...
function cvio_stylesheets() {
	...
	/*Styles*/
	wp_enqueue_style( 'cvio-style', get_stylesheet_uri() );
...
function cvio_scripts() {
	...
	wp_enqueue_script( 'swiper', get_template_directory_uri() . '/assets/js/swiper.js', array(), '1.0.0', true );
